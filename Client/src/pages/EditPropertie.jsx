...
export default function EditPropertie() {
  ...
  const getPropertie = async () => {
    try {
      const res = await fetch(`/api/properties/get/${params.id}`);
      ...
      setErrorForm({message: err.message});
      console.log(err)
    }
  }
  ...
  const handleSubmit = async (e) =>{
    ...
    try{
      ...
      if(error === null){
        const res = await fetch(`/api/properties/update/${params.id}`, {
          method: "PUT",
          headers: {
  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto ">
        <h2 className='my-10 text-2xl text-center'>Editar propiedad</h2>
      ...
      <div className="grid grid-cols-60/40">
        <div>
            <form className='w-[87%] mx-auto' onSubmit={handleSubmit}>
                ...
                <textarea name="" id="description" defaultValue={formdata.description}
                onChange={handleChange}
                ...
                />
                  ...
                  <select id="propertyType" name="propertyType" onChange={handleChange}
                   value={formdata.propertyType} className='w-full p-2 border-2 mb-4'>
